...
public class EcoNewsByIdWithoutImageTest extends CreateNewsRunner {
    ...
    public void testUpdateEcoNewsByIdWithoutImage() {
        ...
        softAssert.assertEquals(ecoNews.getAuthor().getId(), testValueProvider.getUserId(),
                "Author ID should match expected");
        softAssert.assertEquals(ecoNews.getAuthor().getName(), testValueProvider.getUserName(),
