package org.greencity.ui.CreateNews.steps;
...
import static org.greencity.utils.NewsTestData.TEST_SOURCE;

public class CreateNewsStepsEN extends BaseTestRunner {

    private CreateNewsPage createNewsPage;
    protected WebDriver driver;

    public CreateNewsStepsEN(CreateNewsPage createNewsPage, WebDriver driver) {
        this.createNewsPage = createNewsPage;
        this.driver = driver;
    }

    @Step("Verify that Create News page is opened")
    public void verifyPageOpened() {
        Assert.assertTrue(createNewsPage.isPageOpened(), "Create News page should be opened");
    }

    @Step("Verify title field is empty and counter is {0}/170")
    public void verifyTitleEmpty() {
    ...
    @Step("Verify image upload component")
    ...
    @Step("Verify author field")
    public void verifyAuthorField(String expectedAuthor) {
    ...
    @Step("Verify action buttons (Cancel, Preview, Publish)")
    ...
    @Step("Click Cancel and verify modal")
    public void clickCancelAndVerifyModal() {
    ...
    @Step("Click Preview and verify NewsPreviewPage")
    public void clickPreviewAndVerifyNewsPreviewPage() {
    ...
    @Step("Click Publish and verify snackbar message")
    public void clickPublishAndVerifySnackbarMessage() {
